...
const suppliers = [
  {
    ...
    description:
      "Soluções completas em PEAD e PVC tubos, conexões e válvulas para redes de abastecimento, esgotamento sanitário e Poços de Visita (PV) Rotomoldados.",
    pdfs: [
      { file: "catalogo completo asperbras.pdf", label: "Catálogo Completo" },
      {
        file: "catalogo saneamento rotomoldagem.pdf",
        label: "Saneamento Rotomoldagem",
      },
      { file: "CATÁLAGO_PEAD.pdf", label: "PEAD" },
      {
        file: "ASPERBRAS - Lâmina Linha Keeper.pdf",
        label: "Lâmina Linha Keeper",
      },
      { file: "catalogo saneamento tubos.pdf", label: "Saneamento Tubos" },
      { file: "CATALOGO ASPERBRAS PREDIAL.pdf", label: "Predial" },
      {
        file: "ASPERBRAS - Lâmina Serve Festa.pdf",
        label: "Lâmina Serve Festa",
      },
      {
        file: "Apresentação Linha Keeper ASPERBRAS 2025.pdf",
        label: "Linha Keeper",
      },
    ],
  },
  {
    ...
    description:
      "Especialista em PEAD Corrugado, atendendo setores de saneamento, drenagem, mineração, energia, telecomunicações e indústria.",
    pdfs: [
      {
        file: "catalogo_Tuboseconexões_2025-2.pdf_compressed.pdf",
        label: "Tubos e Conexões",
      },
      {
        file: "catalogo_atualizado_Ecodren_2025-1.pdf_compressed (1).pdf",
        label: "Ecodren",
      },
      {
        file: "catalogo_ecosan_atual_2025-1.pdf_compressed.pdf",
        label: "Ecosan",
      },
      {
        file: "catalogo_dutos_eletrodutos_atualizado_2025-.pdf",
        label: "Dutos e Eletrodutos 2025",
      },
    ],
  },
  {
    ...
    description:
      "Uma das maiores importadoras do Brasil, fornecendo tubos e válvulas em Ferro Fundido com alta durabilidade.",
    pdfs: [
      {
        file: "Catálogo R2 San - PEAD Compressão_251028_144107.pdf",
        label: "PEAD Compressão",
      },
      {
        file: "Catálogo R2 San - PEAD Eletro e Termofusão_251028_144142.pdf",
        label: "PEAD Eletro e Termofusão",
      },
      {
        file: "Catálogo R2 San - Válvulas - 2024_251028_143954.pdf",
        label: "Válvulas",
      },
      {
        file: "Catálogo R2 San - Tubos - 2024_251028_144031.pdf",
        label: "Tubos",
      },
    ],
  },
...
function SupplierCard({ supplier }: { supplier: (typeof suppliers)[0] }) {
  ...
  return (
    <div className="bg-white rounded-2xl shadow-md overflow-hidden border border-gray-100">
      <div className="p-6">
        <h3 className="text-2xl font-bold text-[#0D3280] mb-2">
          {supplier.name}
        </h3>
        ...
        <div className="flex gap-3 flex-wrap">
          ...
          >
            ...
            {open
              ? "Ocultar catálogos"
              : `Ver catálogos (${supplier.pdfs.length})`}
          </button>
        </div>
      </div>
              ...
              <li key={entry.file}>
                ...
                >
                  ...
                  <span className="group-hover:underline">
                    {entry.label ?? formatPdfName(entry.file)}
                  </span>
                </a>
              </li>
            ))}
  ...
  return (
    ...
    >
      ...
      >
        ...
        <h2 className="text-center text-[#0D3280] font-bold text-lg mb-1">
          Novidades ASPERBRAS
        </h2>
        <p className="text-center text-gray-500 text-sm mb-5">
          Clique em um produto para ver o catálogo completo
        </p>
...
export default function Home() {
  const [activeTab, setActiveTab] = useState<
    "inicio" | "quem-somos" | "catalogos" | "contato"
  >("inicio");
    ...
    <div className="min-h-screen bg-[#F4F7FC] flex flex-col">
        ...
        <main>
          ...
          <section className="py-12 px-4 bg-white">
            <div className="max-w-5xl mx-auto">
              <p className="text-center text-sm font-semibold uppercase tracking-widest text-gray-400 mb-8">
                Empresas que confiam na W7 Saneamento
              </p>
              <div
              ...
              >
                ...
                >
                  {[
                    ...
                    { src: "/files/clientes/ITAOCARA.png", alt: "Itaocara" },
                    { src: "/files/clientes/bhatel.jpg", alt: "Bhatel" },
                    { src: "/files/clientes/hidrotel.jpg", alt: "Hidrotel" },
                    { src: "/files/clientes/Gomes.jpeg", alt: "Gomes" },
                    { src: "/files/clientes/hidroluna.jpg", alt: "Hidroluna" },
          ...
          <section className="py-16 px-4 bg-white">
            <div className="max-w-4xl mx-auto">
              <h2 className="text-3xl font-bold text-[#0D3280] mb-8 text-center">
                Nosso Portfólio
              </h2>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                <div className="bg-[#F4F7FC] rounded-2xl p-6">
                  ...
                  <p className="text-gray-600 text-sm leading-relaxed">
                    Soluções completas em <strong>PEAD</strong> e{" "}
                    <strong>PVC</strong> tubos, conexões e válvulas para redes
                    de abastecimento, esgotamento sanitário e Poços de Visita
                    (PV) Rotomoldados.
                  </p>
                </div>
                <div className="bg-[#F4F7FC] rounded-2xl p-6">
                  ...
                  <p className="text-gray-600 text-sm leading-relaxed">
                    Especialista em <strong>PEAD Corrugado</strong>, atendendo
                    setores de saneamento, drenagem, mineração, energia,
          ...
          <section className="py-16 px-4 bg-white">
            <div className="max-w-5xl mx-auto">
              <h2 className="text-3xl font-bold text-[#0D3280] mb-12 text-center">
                Como trabalhamos
              </h2>
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-8">
                <div className="text-center px-4">
                  ...
                  <h3 className="text-lg font-semibold text-[#0D3280] mb-2">
                    Distribuição
                  </h3>
                  <p className="text-gray-500 text-sm">
                    Amplo portfólio de produtos para obras de saneamento, com
                    pronta entrega e atendimento a todo o Brasil.
                  </p>
                </div>
                <div className="text-center px-4">
                  <div className="w-16 h-16 bg-[#0D3280]/10 rounded-full flex items-center justify-center mx-auto mb-4">
                  ...
                  <p className="text-gray-500 text-sm">
                    Trabalhamos apenas com fabricantes certificados, garantindo
                    produtos com total conformidade às normas técnicas.
                  </p>
                </div>
                <div className="text-center px-4">
                  <div className="w-16 h-16 bg-[#0D3280]/10 rounded-full flex items-center justify-center mx-auto mb-4">
                  ...
                  <p className="text-gray-500 text-sm">
                    Suporte técnico especializado de quem conhece o canteiro de
                    obra, orientando na especificação e escolha dos produtos
                    certos para cada projeto.
                  </p>
                </div>
              </div>
            </div>
      ...
      {activeTab === "quem-somos" && (
        <main className="py-12 px-4 flex-1">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl font-bold text-[#0D3280] mb-6 text-center">
              Quem Somos
            </h2>
            <div className="bg-white rounded-2xl shadow-sm p-8 text-gray-600 leading-relaxed space-y-4 text-lg">
              <p>
                A <strong className="text-[#0D3280]">W7 Saneamento</strong>{" "}
                nasceu de{" "}
                <strong className="text-[#0D3280]">
                  15 anos de expertise em infraestrutura de saneamento
                </strong>
                , com uma trajetória consolidada no topo do mercado mundial de
                PVC. Ao longo dessa jornada, construímos um histórico de
                excelência atendendo aos mais exigentes clientes do Brasil, como{" "}
                <strong className="text-[#0D3280]">Sanepar</strong>,{" "}
                <strong className="text-[#0D3280]">Casan</strong>,{" "}
                <strong className="text-[#0D3280]">Águas de Joinville</strong> e
                diversos <strong className="text-[#0D3280]">Samaes</strong> em
                Santa Catarina e no Paraná, além de grandes empreiteiras e
                revendas nacionais.
              </p>
              <p>
                Somos especialistas na distribuição de materiais para saneamento
                básico, atuando como parceiros estratégicos de construtoras,
                empreiteiras, prefeituras, companhias de saneamento e
                profissionais especializados em todo o território brasileiro.
              </p>
            </div>
            ...
            <section className="mt-10 bg-[#0D3280] text-white rounded-2xl py-12 px-8 text-center">
              ...
              <p className="text-lg sm:text-xl text-blue-200 leading-relaxed max-w-3xl mx-auto">
                Nossa missão é viabilizar projetos de infraestrutura através do
                fornecimento de produtos de altíssima qualidade, unindo
                agilidade logística e suporte técnico especializado de quem
                conhece o canteiro de obra e as necessidades do campo.
              </p>
            </section>
            ...
            <section className="mt-10">
              ...
              <div className="bg-white rounded-2xl shadow-sm p-8 text-gray-600 leading-relaxed text-lg text-center">
                <p>
                  Nossa missão é impulsionar o setor de saneamento através de um
                  compromisso inegociável com a agilidade. Unimos produtos de
                  alta performance ao suporte técnico de quem entende o campo,
                  garantindo que cada demanda seja resolvida com o
                  profissionalismo e a velocidade que a obra exige.
                </p>
              </div>
            </section>
          </div>
      ...
      {activeTab === "catalogos" && (
        <main className="py-12 px-4 flex-1">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl font-bold text-[#0D3280] mb-2">
              Catálogos e Fornecedores
            </h2>
            <p className="text-gray-500 mb-8">
              Acesse o site de cada fornecedor ou faça o download dos catálogos
              técnicos.
            </p>
      ...
      <footer className="bg-[#0D3280] text-blue-200 text-center text-sm py-6 mt-12">
        © {new Date().getFullYear()} W7 Saneamento. Todos os direitos
        reservados.
      </footer>
